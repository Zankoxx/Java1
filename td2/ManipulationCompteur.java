...
public class ManipulationCompteur {
    public static void main(String[] args) {
		...
		System.out.println("Vecteur.td2.Compteur 1 : "+c1.toString());
		System.out.println("On crée un deuxième compteur");
		Compteur c2=new Compteur();
		System.out.println("Vecteur.td2.Compteur 2 : "+c2.toString());
		...
		System.out.println("Vecteur.td2.Compteur 1 : "+c1.toString());
		System.out.println("Vecteur.td2.Compteur 2 : "+c2.toString());
		System.out.println("Vecteur.td2.Compteur 3 : "+c3.toString());
	}
}
